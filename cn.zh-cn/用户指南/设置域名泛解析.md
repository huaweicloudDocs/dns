...
3.  根据界面提示填写参数配置，参数说明如[表1](#ta6b1707711b04a89b824b97109ef7db2)所示。
    ...
    **表 1**  添加泛解析记录
    ...
    <td class="cellrowborder" valign="top" width="46.12%" headers="mcps1.2.4.1.2 "><p id="a86bc40b8482242fd9e314206ac399239"><a name="a86bc40b8482242fd9e314206ac399239"></a><a name="a86bc40b8482242fd9e314206ac399239"></a>记录集的有效缓存时间，以秒为单位。</p>
    </td>
