...
<td class="cellrowborder" valign="top" width="51.67516751675167%" headers="mcps1.2.4.1.3 "><p id="p719462617411"><a name="p719462617411"></a><a name="p719462617411"></a>支持按照记录集状态、记录集类型、域名、记录集的值、记录集ID以及标签等条件全局搜索记录集。</p>
</td>
</tr>
