# 记录集管理简介<a name="dns_usermanual_0035"></a>
...
<td class="cellrowborder" valign="top" width="51.67516751675167%" headers="mcps1.2.4.1.3 "><a name="ul446519315616"></a><a name="ul446519315616"></a><ul id="ul446519315616"><li>域名添加至云解析服务后，系统默认创建SOA类型和NS类型的记录集。</li><li>每个域名支持添加500个记录集。</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="30.193019301930192%" headers="mcps1.2.4.1.2 "><p id="p112681929453"><a name="p112681929453"></a><a name="p112681929453"></a>介绍如何修改、删除、批量删除以及查看记录集。</p>
</td>
<td class="cellrowborder" valign="top" width="51.67516751675167%" headers="mcps1.2.4.1.3 "><a name="ul1356620454552"></a><a name="ul1356620454552"></a><ul id="ul1356620454552"><li>记录集添加成功后不支持修改“线路类型”。</li><li>不支持修改、删除以及暂停解析系统默认创建的SOA类型和NS类型的记录集。</li><li>删除记录集后，不可恢复。</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51.67516751675167%" headers="mcps1.2.4.1.3 "><a name="ul6494153242211"></a><a name="ul6494153242211"></a><ul id="ul6494153242211"><li>支持按照记录集状态、记录集类型、域名、记录集的值、记录集ID以及标签等条件全局搜索记录集。</li><li>通过“记录集”总览页面修改、暂停解析或者删除记录集与在某一域名的记录集页面的操作效果相同。</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51.67516751675167%" headers="mcps1.2.4.1.3 "><a name="ul137066249247"></a><a name="ul137066249247"></a><ul id="ul137066249247"><li>批量导入的上传文件格式支持xlsx，大小不超过2MB。</li><li>为保证导入文件的规范性，请通过管理控制台下载导入模板并填写。</li><li>每次最多可以导入500条解析记录，超出的部分将不会导入。</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51.67516751675167%" headers="mcps1.2.4.1.3 "><p id="p191991810111316"><a name="p191991810111316"></a><a name="p191991810111316"></a>支持导出域名的所有记录集，包括系统默认生成的NS类型和SOA类型记录集。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51.67516751675167%" headers="mcps1.2.4.1.3 "><p id="p1556911220138"><a name="p1556911220138"></a><a name="p1556911220138"></a>迁移前，需要到域名原服务商获取域名所有的解析记录。</p>
<p id="p2770134818341"><a name="p2770134818341"></a><a name="p2770134818341"></a>迁移后，需要到域名注册商处修改域名的“DNS服务器地址”为华为云DNS。</p>
</td>
</tr>
</tbody>
</table>
