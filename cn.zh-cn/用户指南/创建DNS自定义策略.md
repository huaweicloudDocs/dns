...
1.  登录管理控制台。
2.  在控制台页面，将鼠标移动至右上方的帐号名，在下拉列表中选择“统一身份认证”。
...
8.  在“策略内容”下配置自定义策略。
    ...
    5.  （可选）添加条件，单击“添加条件”，选择“条件键”，选择“运算符”，根据运算符类型填写相应的值。
        ...
        **表 2**  全局级请求条件
        ...
        <td class="cellrowborder" valign="top" width="63.366336633663366%" headers="mcps1.2.4.1.3 "><p id="p14304227113819"><a name="p14304227113819"></a><a name="p14304227113819"></a>帐号名称。</p>
        </td>
        </tr>
