...
5.  设置记录集参数，如[表1](#table219785892310)所示。
    ...
    **表 1**  A类型记录集参数说明
    ...
    <td class="cellrowborder" valign="top" width="46.01%" headers="mcps1.2.4.1.2 "><p id="p667042892619"><a name="p667042892619"></a><a name="p667042892619"></a>可选参数，解析记录的权重。默认值为1，取值范围：0~100。</p>
