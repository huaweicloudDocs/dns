...
7.  设置记录集参数，如[表1](#table3171006112739)所示。
    ...
    **表 1**  添加AAAA类型记录集参数说明
    ...
    <td class="cellrowborder" valign="top" width="46.12%" headers="mcps1.2.4.1.2 "><p id="p13661098305"><a name="p13661098305"></a><a name="p13661098305"></a>可选参数，解析记录的权重。默认值为1，取值范围：0~100。</p>
