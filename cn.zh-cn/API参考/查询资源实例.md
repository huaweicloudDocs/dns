...
-   参数说明
    ...
    **表 2**  请求样例的参数说明
    ...
    <p id="ab180c46a42a842f6a621fe9ce4477e1f"><a name="ab180c46a42a842f6a621fe9ce4477e1f"></a><a name="ab180c46a42a842f6a621fe9ce4477e1f"></a>最多包含10个key，每个key下面的value最多10个，结构体不能缺失，key不能为空或者空字符串。Key不能重复，同一个key中values不能重复。</p>
    </td>
    </tr>
    ...
    <p id="a25efbc3e17864efb9efa455708c45aa6"><a name="a25efbc3e17864efb9efa455708c45aa6"></a><a name="a25efbc3e17864efb9efa455708c45aa6"></a>最多包含10个key，每个key下面的value最多10个，结构体不能缺失，key不能为空或者空字符串。Key不能重复，同一个key中values不能重复。</p>
    </td>
    </tr>
...
-   参数说明
    ...
    **表 5**  响应样例的参数说明
    ...
    <td class="cellrowborder" valign="top" width="20.7%" headers="mcps1.2.4.1.2 "><p id="a0d48338359754182b83c7d83a8a3fcd3"><a name="a0d48338359754182b83c7d83a8a3fcd3"></a><a name="a0d48338359754182b83c7d83a8a3fcd3"></a>Array of objects</p>
    </td>
    ...
    **表 6**  resource参数数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="20.3%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0123490185_p62596018369"><a name="zh-cn_topic_0123490185_p62596018369"></a><a name="zh-cn_topic_0123490185_p62596018369"></a>Array of objects</p>
    </td>
