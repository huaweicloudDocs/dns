...
<tbody><tr id="row6301875173129"><td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.1 "><p id="p5124116173129"><a name="p5124116173129"></a><a name="p5124116173129"></a>zone_id</p>
</td>
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p65804667173129"><a name="p65804667173129"></a><a name="p65804667173129"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p56820233173129"><a name="p56820233173129"></a><a name="p56820233173129"></a>所属zone ID。</p>
</td>
</tr>
</tbody>
</table>
...
-   参数说明
    ...
    **表 2**  请求样例的参数说明
    ...
    <td class="cellrowborder" valign="top" width="17.89%" headers="mcps1.2.5.1.3 "><p id="p15148058212620"><a name="p15148058212620"></a><a name="p15148058212620"></a>int</p>
    </td>
    ...
    <tr id="row11879661194927"><td class="cellrowborder" valign="top" width="22.45%" headers="mcps1.2.5.1.1 "><p id="p24376203194927"><a name="p24376203194927"></a><a name="p24376203194927"></a>tags</p>
    </td>
    <td class="cellrowborder" valign="top" width="21.29%" headers="mcps1.2.5.1.2 "><p id="p28315431194927"><a name="p28315431194927"></a><a name="p28315431194927"></a>否</p>
    </td>
...
-   参数说明
    ...
    **表 4**  响应样例的参数说明
    ...
    <p id="p51374523175323"><a name="p51374523175323"></a><a name="p51374523175323"></a>取值范围：PENDING_CREATE，ACTIVE，PENDING_DELETE，PENDING_UPDATE，ERROR。</p>
    </td>
    </tr>
