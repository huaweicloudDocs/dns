...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=DNS&api=CreateRecordSetWithLine)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
-   参数说明
    ...
    **表 2**  请求样例的参数说明
    ...
    <td class="cellrowborder" valign="top" width="17.57%" headers="mcps1.2.5.1.2 "><p id="p32296167173211"><a name="p32296167173211"></a><a name="p32296167173211"></a>否</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="38.37%" headers="mcps1.2.5.1.4 "><p id="p30119514195034"><a name="p30119514195034"></a><a name="p30119514195034"></a>资源标签。详细信息请参见<a href="#table3911153711258">表3</a>。</p>
    ...
    <p id="p11866386153334"><a name="p11866386153334"></a><a name="p11866386153334"></a>取值范围：0~1000。</p>
    ...
    **表 4**  alias\_target对象参数说明
    ...
    <td class="cellrowborder" valign="top" width="14.78%" headers="mcps1.2.5.1.2 "><p id="p374211125916"><a name="p374211125916"></a><a name="p374211125916"></a>否</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="14.78%" headers="mcps1.2.5.1.2 "><p id="p117422135911"><a name="p117422135911"></a><a name="p117422135911"></a>否</p>
    </td>
