...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=DNS&api=UpdateRecordSets)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
-   参数说明
    ...
    **表 2**  请求样例的参数说明
    ...
    <p id="p58780313154248"><a name="p58780313154248"></a><a name="p58780313154248"></a>取值范围：0~1000</p>
...
-   参数说明
    ...
    **表 3**  响应样例的参数说明
    ...
    <td class="cellrowborder" valign="top" width="62.1%" headers="mcps1.2.4.1.3 "><p id="abe651c805e8e47d0b3a371ae336baddd"><a name="abe651c805e8e47d0b3a371ae336baddd"></a><a name="abe651c805e8e47d0b3a371ae336baddd"></a>别名记录。详细信息请参见<a href="#table6127103741118">表5</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
