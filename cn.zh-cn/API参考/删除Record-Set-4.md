...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=DNS&api=DeleteRecordSets)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。

## URI<a name="section41336317"></a>

DELETE /v2.1/zones/\{zone\_id\}/recordsets/\{[recordset\_id](查询单个Zone下Record-Set列表-3.md)\}
...
-   参数说明
    ...
    **表 2**  响应样例的参数说明
    ...
    <td class="cellrowborder" valign="top" width="62.3%" headers="mcps1.2.4.1.3 "><p id="abe651c805e8e47d0b3a371ae336baddd"><a name="abe651c805e8e47d0b3a371ae336baddd"></a><a name="abe651c805e8e47d0b3a371ae336baddd"></a>别名记录。详细信息请参见<a href="#table13312833121015">表4</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
