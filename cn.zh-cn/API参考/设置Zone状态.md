...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=DNS&api=UpdatePublicZoneStatus)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。

## URI<a name="section33323423"></a>

PUT /v2/zones/\{zone\_id\}/statuses
...
<td class="cellrowborder" valign="top" width="51.55%" headers="mcps1.2.5.1.4 "><p id="p20315403"><a name="p20315403"></a><a name="p20315403"></a>待设置zone的ID。</p>
...
-   请求参数
    ...
    **表 2**  请求样例的参数说明
    ...
    <td class="cellrowborder" valign="top" width="38.37%" headers="mcps1.2.5.1.4 "><p id="p5093610513636"><a name="p5093610513636"></a><a name="p5093610513636"></a>Zone状态。</p>
...
-   请求样例
    ...
    设置域名Zone ID为“2c9eb155587194ec01587224c9f90149”的域名状态。

    ```
    PUT https://{DNS_Endpoint}/v2/zones/2c9eb155587194ec01587224c9f90149/statuses
    ```
...
-   要素说明
    ...
    **表 3**  响应样例的要素说明
    ...
    <p id="p286121420434"><a name="p286121420434"></a><a name="p286121420434"></a>详细信息请参见<a href="#table0172144213344">表4</a>。</p>
    </td>
    </tr>
